...
/**
 * Write a description of class TestWorld6 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class TestWorld6Count extends World
{
    ...
    {    
        ...
        showText("TestWorld6Count", 8, BASELINE-LIMIT-3);
        prepare();
    }
    ...
    private void prepareColumn(int column, int numberOfLeaves){
        ...
        CountTester kara = new CountTester();
